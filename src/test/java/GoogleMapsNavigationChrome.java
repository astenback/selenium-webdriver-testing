...
public class GoogleMapsNavigationChrome {
    ...
    public static void startingPointToDestination(@Optional ("New York City, New York") String startingPoint,
        ...
        // Working on headless option for Chrome
        System.out.println("Headess is " + headless);
    ...
    public static void main (String args[]){
        ...
        GoogleMapsNavigationChrome.startingPointToDestination("Miami, Florida", "Seattle, Washington", headless);
        GoogleMapsNavigationChrome.startingPointToDestination("New York City, New York", "Los Angeles, California", headless);
        GoogleMapsNavigationChrome.startingPointToDestination("Portland, Maine", "San Diego, California", headless);
